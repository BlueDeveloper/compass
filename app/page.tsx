          ...
          <div className={styles.compassArea}>
            <div className={styles.compassSvgWrap}>
              <svg width="100%" height="100%" viewBox="-20 -20 340 340" overflow="visible">
                ...
                <line x1={smallCrossX - 12} y1={smallCrossY}      x2={smallCrossX + 12} y2={smallCrossY}      stroke="#000" strokeWidth="1.95" />
                <line x1={smallCrossX}      y1={smallCrossY - 12} x2={smallCrossX}      y2={smallCrossY + 12} stroke="#000" strokeWidth="1.95" />
              </svg>
            </div>
          </div>
